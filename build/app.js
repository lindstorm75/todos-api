...
app.put("/todos/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, raw_1, allowed_1, filteredData, todo, newOjb, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                raw_1 = req.body;
                allowed_1 = ["title", "completed"];
                filteredData = Object.keys(raw_1)
                    .filter(function (key) { return allowed_1.includes(key); })
                    .reduce(function (obj, key) {
                    obj[key] = raw_1[key];
                    return obj;
                }, {});
                return [4 /*yield*/, Todo_1.TodoModel.findOneAndUpdate({ id: id }, filteredData)];
            case 2:
                todo = _b.sent();
                newOjb = {};
                newOjb.id = todo.id;
